...
- **Accurate AI with thinking modules**: GPT-5 able to process text, audio, images, youtube videos and article links. Can also scrape online for updated information
- **Image generation with multiple providers such as Seedream and Gemini**: Astonishing image creation using the finest models, providing realistic images
- **Image manipulation and edits with AI**: Image edits using Seedream and QwenEdit to create realistic edits of anything you'd like in any picture
...
- **Several games such as**: Chess, poker, truco, slot machine, betting games, tic-tac-toe, hangman, quiz, crossword, detective and investigation games, pokemon and much more.
- **Horoscope**: Daily predictions for your zodiac sign.
- **Personality and MBTI**: Get Edgar to analyze your entire personality and enneagram based on your conversation! All information will be based in your chat, to get the most accurate response .
- **Audio manipulation**: Change voicenotes in group, pitch, speed and much more
- **Fun interactions**: Many other interactions such as image filters, effects, hairstyle change, hogwarts selector, pokedex and much more.

### Useful Tools
- **Encryption and Encoding**: Encrypt messages, encode in morse, binary, base64.
- **Code Obfuscation**: Protect your source code.
- **Network Tools**: Whois, IP log, Shodan, SQLMap, WPScan, Nmap, aggressive DNS and Subdomain scanner all within whatsapp.
- **Integrated IDE**: Run code from any language directly on WhatsApp.
- **Code and pentest Agent**: Specific AI to guide through pentesting and cyberkill process, and providing assistance with coding.
...
- **Picture filters**: Edit your pictures and create art with surreal filters, ghibli and anime styles, minecraft style and others.
- **Audio Editing and Effects**: Edit audio and create sound effects.
- **Advanced Image generation and Edit**: Create and edit images with any prompt you'd like using seedream v4.5
...
> ᴄᴏᴍᴘʟᴇᴛᴇ ᴍᴇɴᴜ
| .menu ai
> ᴄʀᴇᴀᴛɪᴏɴs, ᴇᴅɪᴛɪɴɢ, ᴀɴᴅ ᴀɪ
| .menu dl
> ᴀʟʟ ᴋɪɴᴅs ᴏꜰ ᴅᴏᴡɴʟᴏᴀᴅs
| .menu util
> ᴛᴏᴏʟs ᴀɴᴅ ᴜᴛɪʟɪᴛɪᴇs
| .menu hacker
> ʜᴀᴄᴋɪɴɢ ᴀɴᴅ ᴅᴇᴠᴇʟᴏᴘᴇʀ ᴛᴏᴏʟs
| .menu study
> sᴛᴜᴅᴇɴᴛ ᴍᴇɴᴜ ᴡɪᴛʜ sᴛᴜᴅʏ ᴛᴏᴏʟs
| .menu store
> ᴮˡᵃᶜᵏ ᶜᵃᵗ sᴛᴏʀᴇ
| .menu games
> ᴄʜᴀʟʟᴇɴɢᴇs, ɢᴀᴍᴇs ᴀɴᴅ ᴘʟᴀʏ
| .menu audios
> ᴀᴜᴅɪᴏ ᴇꜰꜰᴇᴄᴛs ᴀɴᴅ ᴍᴏᴅɪꜰɪᴇʀs
| .menu media
> ᴍᴇᴍᴇs, ғɪʟᴛᴇʀs ᴀɴᴅ ᴍᴏʀᴇ
| .menu search
> ɢᴇɴᴇʀᴀʟ ᴄᴏɴsᴜʟᴛs ᴀɴᴅ sᴇᴀʀᴄʜᴇs
| .menu cassino
> ᴄᴏʀᴠᴏ ᴄᴀsɪɴᴏ
| .menu fun
> ᴇɴᴛᴇʀᴛᴀɪɴᴍᴇɴᴛ ᴀɴᴅ ᴘʟᴀʏ
| .menu actions
> ᴀᴄᴛɪᴏɴs ʙᴇᴛᴡᴇᴇɴ ᴍᴇᴍʙᴇʀs
| .menu tools
> ʙᴏᴛ ᴛᴏᴏʟs
| .menu religion
> ʀᴇʟɪɢɪᴏᴜs ᴍᴇɴᴜ, sᴄʀɪᴘᴛs ᴀɴᴅ ᴘᴀssᴀɢᴇs
| .menu +18
> ᴀᴅᴜʟᴛ ᴄᴏɴᴛᴇɴᴛ
|┅┅─❖  ⸸  ❖─┅┅
| 💠 ADMINISTRATION
...
> ᴀᴅᴍɪɴ ᴛᴏᴏʟs
| .menu functions
> ᴀᴜᴛᴏᴍᴀᴛɪᴏɴ ᴀɴᴅ ɢʀᴏᴜᴘ ᴍᴀɴᴀɢᴇᴍᴇɴᴛ
ᒻ┅─────┅❖ ⸸ ❖─┅─────┅ 
...
```bash
   git clone https://github.com/ARCANGEL0/EdgarAllanBot.git
   cd EdgarAllanBot 
```
...
## Contact
<img height="10%" width="100%" src="arc.png" > <br>
╭─┅──┅❖ ♱ ❖─┅──┅<br>
| ⑊ 𝔈𝔡𝔤𝔞𝔯 𝔄𝔩𝔩𝔞𝔫 𝔅𝔬𝔱 𓄿  <br>
| 𝕯𝖊𝖛𝖊𝖑𝖔𝖕𝖊𝖉 𝖇𝖞: ⛧ Ｈｅｎｒｙ ░ Λｒｃａｎｇｅｌｏ <br>
⦦⎼⎼⎼⎼⎼⎼⎼⎼⎼⎼ <br>

[𝔚𝔥𝔞𝔱𝔰𝔞𝔭𝔭](wa.me/351927285125) | [ℑ𝔫𝔰𝔱𝔞𝔤𝔯𝔞𝔪](instagram.com/h.arcangelo)<br>
[𝔚𝔢𝔟𝔰𝔦𝔱𝔢](https://arcangelo.net) | [𝔈𝔪𝔞𝔦𝔩](mailto:henry.arcangello@gmail.com)<br>
 
<br>
To use 𝔈𝔡𝔤𝔞𝔯 ꓥ𝔩𝔩𝔞𝔫 𝔅𝔬𝔱 <br> 

--- Just click [here](https://wa.me/447391692659) 
<br><br>
╰─┅──┅❖ ⸸ ❖─┅──┅<br>
