...
const _makeWaSocket = (baileysModule.default && (typeof baileysModule.default === 'function'
    ? baileysModule.default
    : (baileysModule.default.default || baileysModule.default))) || baileysModule

const makeWALegacySocket = baileysModule.makeWALegacySocket || (baileysModule.default && baileysModule.default.makeWALegacySocket)
const downloadContentFromMessage = baileysModule.downloadContentFromMessage || (baileysModule.default && baileysModule.default.downloadContentFromMessage)
const jidDecode = baileysModule.jidDecode || (baileysModule.default && baileysModule.default.jidDecode)
const areJidsSameUser = baileysModule.areJidsSameUser || (baileysModule.default && baileysModule.default.areJidsSameUser)
const generateForwardMessageContent = baileysModule.generateForwardMessageContent || (baileysModule.default && baileysModule.default.generateForwardMessageContent)
const generateWAMessageFromContent = baileysModule.generateWAMessageFromContent || (baileysModule.default && baileysModule.default.generateWAMessageFromContent)
const WAMessageStubType = baileysModule.WAMessageStubType || (baileysModule.default && baileysModule.default.WAMessageStubType)
const extractMessageContent = baileysModule.extractMessageContent || (baileysModule.default && baileysModule.default.extractMessageContent)

const WAProtoModule = await import('@whiskeysockets/baileys/WAProto/index.js')
const proto = WAProtoModule.proto || WAProtoModule.default?.proto || WAProtoModule.default || WAProtoModule

console.log("Tem WebMessageInfo?", !!proto?.WebMessageInfo);
 console.log(Object.keys(proto).slice(0, 20));
    ...
    return await conn.sendMessage(jid, {
      ...
      ...options
        ...
        reply: {
             ...
             * @param {import('@adiwajshing/baileys').proto.WebMessageInfo | Object | undefined} quoted
